...
export const actions: ActionTree<UserState, CoreState> = {
  [USER_REQUEST]: ({ commit, dispatch }: { commit: any; dispatch: any }) => {
    ...
    log(
      dispatch,
      "Profile Access",
      "Attempting request for user profile data",
      Status.Init
    );
    profileService.get().subscribe(
      ...
      (errors: any) => {
        ...
        log(
          dispatch,
          "Profile Access",
          "Error while accessing the User profile data",
          Status.Error
        );
  ...
  [AUTHENTICATOR_REQUEST]: ({
    ...
    return new Promise((resolve, reject) => {
      log(
        dispatch,
        "2FA Setup",
        "Attempting request for setup 2-Step verification",
        Status.Init
      );
  ...
  [AUTHENTICATOR_ENABLE_REQUEST]: (
    ...
    return new Promise((resolve, reject) => {
      log(
        dispatch,
        "2FA Setup",
        "Attempting request for enabling 2-Step verification",
        Status.Init
      );
      profileService.setAuthenticator(authenticator).subscribe(
        (result: any) => {
          ...
          log(
            dispatch,
            "2FA Enabled",
            "2-Step Verification have been successfully enabled",
            Status.Success
          );
          resolve(result);
        },
        (errors: any) => {
          ...
          log(
            dispatch,
            "2FA Error",
            "2-Step Verification couldn't be enabled",
            Status.Error
          );
          reject(errors);
        }
  ...
  [AUTHENTICATOR_CODES_REQUEST]: ({
    ...
    return new Promise((resolve, reject) => {
      log(
        dispatch,
        "2FA Backup Codes",
        "Attempting request for 2-Step verification backup codes",
        Status.Init
      );
      profileService.getAuthenticatorCodes().subscribe(
        (result: any) => {
          log(
            dispatch,
            "2FA Backup Codes",
            "2-Step verification backup codes obtained",
            Status.Success
          );
          resolve(result);
        },
        (errors: any) => {
          log(
            dispatch,
            "2FA Backup Codes",
            "2-Step verification backup codes request error",
            Status.Error
          );
          reject(errors);
        }
      ...
      profileService.disableAuthenticator().subscribe(
        (result: any) => {
          ...
          log(
            dispatch,
            "2FA Disabled",
            "2-Step Verification have been successfully disabled",
            Status.Success
          );
          resolve(result);
        },
      ...
      profileService.resetAuthenticator().subscribe(
        (result: any) => {
          ...
          log(
            dispatch,
            "2FA Reset",
            "2-Step Verification have been successfully reset",
            Status.Success
          );
          resolve(result);
        },
        (errors: any) => {
          ...
          log(
            dispatch,
            "2FA Reset",
            "2-Step Verification couldn't be reset",
            Status.Error
          );
          reject(errors);
        }
