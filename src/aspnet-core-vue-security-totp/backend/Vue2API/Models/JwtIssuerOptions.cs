namespace Vue2API.Models
{
    ...
    {
        public const string Scheme = JwtBearerDefaults.AuthenticationScheme; // "Bearer";
        public const string TwoFactorScheme = "Bearer.TwoFactor";
        ...
        public SigningCredentials JwtSigningCredentials { get; set; }

        public SigningCredentials JwtTwoFactorSigningCredentials { get; set; }
    }
}