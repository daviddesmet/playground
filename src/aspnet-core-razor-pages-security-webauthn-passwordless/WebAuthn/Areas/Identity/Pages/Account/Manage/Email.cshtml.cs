...
namespace WebAuthn.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public EmailModel(SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                var callbackUrl = Url.Page("/Account/ConfirmEmailChange", null, new { userId = userId, email = Input.NewEmail, code = code }, Request.Scheme);
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            var callbackUrl = Url.Page("/Account/ConfirmEmail", null, new { area = "Identity", userId = userId, code = code }, Request.Scheme);
